 ...
 */
?>
<div class="form-group <?php print $classes; ?>"<?php print $attributes; ?>>
  <?php switch ($element['#title_display']):
    case 'inline': case 'before': case 'invisible': ?>
      ...
      <?php if (isset($element['#guidance'])): ?>
        <div class="description"><?php print $element['#guidance']; ?></div>
      <?php endif; ?>
